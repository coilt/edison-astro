...
class ClapatSlider {
  constructor(t, e = {}) {
    if ((this.bindAll(), this.isElement(t)))
      (this.el = t), (this.el.clapat_slider = this)
    else {
      const i = document.querySelectorAll(t)
      for (let t = 0; t < i.length; t++) {
        let s = i[t]
        if (0 == t) (this.el = s), (this.el.clapat_slider = this)
        else {
  ...
  setup() {
    ...
    for (let t = 0; t < i.length; t++) {
      ...
      let o = null
      'vertical' == this.opts.direction
        ? ((o = { el: e, start: l, end: a, length: r, translate: 0 }),
          (this.length += r))
        : ((o = { el: e, start: s, end: n, length: h, translate: 0 }),
          (this.length += h)),
        e.classList.contains(this.opts.clones)
          ? (this.itemsCloned.push(o), (o.clone = !0))
          : (this.itemsInitial.push(o), (o.clone = !1)),
        this.items.push(o)
    }
    ...
    if ('vertical' == this.opts.direction) {
      for (let t = 0; t < s; t++) {
        ...
        ;(e.prevElement = 0 == t ? this.items[s] : this.items[t - 1]),
          (e.nextElement =
            t == s - 1 ? this.items[this.items.length - 1] : this.items[t + 1])
      }
      for (let t = this.items.length - 1; t >= s; t--) {
        const e = this.items[t]
        t == this.items.length - 1
          ? (e.prevElement = this.items[s - 1])
          : (e.prevElement = this.items[t + 1]),
      ...
      for (let t = 0; t < this.items.length; t++) {
        const e = this.items[t]
        ;(e.prevElement =
          0 == t ? this.items[this.items.length - 1] : this.items[t - 1]),
          t == this.items.length - 1
            ? (e.nextElement = this.items[0])
            : (e.nextElement = this.items[t + 1])
      }
    null != this.el &&
      0 != this.opts.click &&
  ...
  calc() {
    ...
    ;(t.progress = gsap.utils.wrap(0, 1, t.currentRounded / e)),
      (t.moveOffset = gsap.utils.wrap(
        0,
        this.length,
        Math.abs(t.currentRounded),
      )),
  ...
  updateUI() {
    ...
    null != this.el &&
      (this.state.currentScrollDirection >= 0
    ...
    for (let a = 0; a < this.items.length; a++) {
      ...
      if (
        (Math.abs(o) < h.length / 2
          ? (h.el.classList.add('clapat-slide-active'),
            h.nextElement.el.classList.add('clapat-slide-next'),
            h.nextElement.nextElement.el.classList.add('clapat-slide-next-two'),
            h.nextElement.nextElement.nextElement.el.classList.add(
            ...
            h.prevElement.prevElement.prevElement.el.classList.add(
              'clapat-slide-prev-three',
            ),
            (this.state.currentSlideItem = h),
            null != l &&
              l !== this.state.currentSlideItem &&
          ...
          : (h.el.classList.remove('clapat-slide-active'),
            h.nextElement.el.classList.remove('clapat-slide-next'),
            h.nextElement.nextElement.el.classList.remove(
              'clapat-slide-next-two',
            ),
            h.nextElement.nextElement.nextElement.el.classList.remove(
              'clapat-slide-next-three',
            ),
            h.prevElement.el.classList.remove('clapat-slide-prev'),
            h.prevElement.prevElement.el.classList.remove(
              'clapat-slide-prev-two',
            ),
            h.prevElement.prevElement.prevElement.el.classList.remove(
              'clapat-slide-prev-three',
            )),
        h.end + r > e && h.start + r < t + e
          ? h.el.classList.add('clapat-slide-visible')
          : h.el.classList.remove('clapat-slide-visible'),
        h.translate != r)
      ) {
        ...
        t &&
          ...
          this.opts.on.slideLeaveViewport(h.el),
          !t &&
            e &&
            'function' == typeof this.opts.on.slideEnterViewport &&
            this.opts.on.slideEnterViewport(h.el)
      }
    }
  ...
  updatePaginationUI() {
    if (
      ...
      let t = null
      t = this.state.currentSlideItem.clone
        ? this.itemsCloned
        : this.itemsInitial
      let e = -1
  ...
  parallax() {
    if (null == this.opts.parallax || 0 == this.opts.parallax) return
    const t = this.viewportSize(),
      e = this.viewportShift(),
      i =
    ...
    for (let s = 0; s < this.items.length; s++) {
      ...
      if (
        (l < 0 &&
          n.end + l < t + e + n.length - this.length &&
          (l += this.length),
          ...
          for (let e = 0; e < this.opts.parallax.length; e++) {
            ...
            if (void 0 !== s.element && void 0 !== s.margin) {
              ...
              for (let t = 0; t < e.length; t++) {
                let i = e[t]
                'vertical' == this.opts.direction
                  ? (i.style.transform = 'translateY(' + l + '%)')
  ...
  snapTargetOnDrag(t) {
    ...
    for (let l = 0; l < this.items.length; l++) {
      ...
      if (Math.abs(r) < a.length / 2) return t - r
    }
    return t
  }
  snapTargetOnWheel(t, e) {
    ...
    for (let n = 0; n < this.items.length; n++) {
      ...
      if (Math.abs(c) < l.length / 2) {
        return a == n && Math.abs(e - t) < this.length
          ? (this.log(
              'Snapping - start and end items are the same, the scroll did not go over a full item',
            ),
            this.state.currentScrollDirection > 0
              ? c < 0
                ? e - (l.length / 2 + c + l.nextElement.length / 2)
                : e - c
              : c < 0
                ? e - c
                : e - c + l.prevElement.length)
          : (this.log('Snapping - start and end items are different'), e - c)
      }
    }
    return e
  }
  getPos({ changedTouches: t, clientX: e, clientY: i, target: s }) {
    return { x: t ? t[0].clientX : e, y: t ? t[0].clientY : i, target: s }
  }
  onDown(t) {
  ...
  onMove(t) {
    ...
    Math.abs(a) > Math.abs(h) && t.cancelable && t.preventDefault(),
      'vertical' == this.opts.direction
        ? ((e.target = n + h * this.opts.speed),
          (e.currentScrollDirection = -Math.sign(h)))
  ...
  onUp(t) {
    ...
    if (
      ((e.flags.mousedown = !1), (e.flags.dragging = !1), (e.off = e.target), i)
    ) {
  ...
  onClick(t) {
    if (this.enabled) {
      if (
        ...
        let e = null
        null != t.target &&
          ((e = t.target.querySelector('a')), null != e && e.click())
      }
  ...
  update() {
    ...
    for (let t = 0; t < this.items.length; t++) {
      ...
      if ('vertical' == this.opts.direction) {
        ...
        ;(this.length += a), (e.start = s), (e.end = n), (e.length = a)
      } else {
        ...
        ;(this.length += l), (e.start = t), (e.end = i), (e.length = l)
      }
    }
    let l = 0
  ...
  onPrev(t) {
    ...
    for (let t = 0; t < this.items.length; t++) {
      ...
      Math.abs(h) < l.length / 2 &&
        ((this.state.target = this.state.target - h + l.prevElement.length),
        (this.state.off = this.state.target))
    }
  }
  onNext(t) {
    ...
    for (let t = 0; t < this.items.length; t++) {
      ...
      Math.abs(h) < l.length / 2 &&
        ((this.state.target =
          this.state.target - (l.length / 2 + h + l.nextElement.length / 2)),
        (this.state.off = this.state.target))
    }
  }
  onWheel(t) {
    ...
    const i = this.state,
      s = 0.2 * normalizeWheel(t).pixelY,
      { x: n, y: l } = this.getPos(t)
    i.flags.dragging = !1
    const { off: a, on: h } = i
    if (
      (this.log('Event timestamp: ' + e + ' Scroll delta ' + s),
