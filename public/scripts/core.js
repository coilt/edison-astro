...
export function Core() {
  ...
  if (!isMobile() && !document.body.classList.contains('disable-cursor')) {
    ...
    document.querySelectorAll('.sticky.left').forEach((element) => {
    ...
    document.querySelectorAll('.sticky.right').forEach((element) => {
      element.addEventListener('mouseenter', function (e) {
        const rcBounds = this.getBoundingClientRect()
    ...
    document.querySelectorAll('#main .sticky.left').forEach((element) => {
      element.addEventListener('mouseenter', function (e) {
        const rcBounds = this.getBoundingClientRect()
    ...
    document.querySelectorAll('#main .sticky.right').forEach((element) => {
      element.addEventListener('mouseenter', function (e) {
        const rcBounds = this.getBoundingClientRect()
